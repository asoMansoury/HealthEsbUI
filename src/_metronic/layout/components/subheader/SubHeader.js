        ...
        >
          ...
          <div className="d-flex align-items-center">
            <a href="#" className="btn btn-light btn-sm font-weight-bold" id="kt_dashboard_daterangepicker"
              ...
              <span className="text-muted font-weight-bold mr-2" id="kt_dashboard_daterangepicker_title">امروز</span>
              <span className="text-primary font-weight-bold" id="kt_dashboard_daterangepicker_date" style={{direction:'rtl'}}>{moment().format('jYYYY-jMM-jDD')}</span>
            </a>
            {/* <QuickActions/> */}
          </div>
        </div>
