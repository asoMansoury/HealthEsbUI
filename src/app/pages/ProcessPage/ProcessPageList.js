...
import printPDF from '../pulseDesignImages/edit1.svg';
...
const headRows = [
    ...
    { id: 'IssueDate', numeric: false, disablePadding: true, label: 'تاریخ اجرای' },
    ...
    return (
      ...
      >
        ...
        <div className={classes.actions}>
          {numSelected > 0 ? (
            <ProcessModalDeleteGroup selected={props.selected} />
          )
            :
            (<Button onClick={addCategoryShow} className='btn-height2 create-btn' variant="info">افزودن فرایند</Button>)}
        </div>
      </Toolbar>
    );
  };
                        ...
                        >
                          ...
                          <TableCell align="center">
                            ...
                            <div style={{ display: !isLoading ? 'block' : 'none' }}>
                                ...
                                <div className="delete-img-con btn-for-select"  dbid={row.id}   onClick={printPdf} ><Print></Print> </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProcessPageList);